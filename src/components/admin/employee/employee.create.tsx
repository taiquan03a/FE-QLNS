...
import { Button, DatePicker, Form, GetProp, Image, Input, message, Select, Spin, Upload, UploadFile, UploadProps } from "antd";
...
const CreateEmployee = ({ isModalOpen, closeModal, refresh }: UserModalProps) => {
