...
const EditCategory = ({ categoryName, isModalOpen, closeModal, refreshCategory, categoryDetail }: CategoryModalProps) => {
    ...
    const handleSubmit = async (values: any) => {
        ...
        try {
            ...
            const newDegree: CategoryType = {
                name: name,
                description: description,
            };
            const response = await editCategory(newDegree, categoryDetail.id, categoryName)
