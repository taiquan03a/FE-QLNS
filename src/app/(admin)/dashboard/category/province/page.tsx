import ProvinceTable from "@/components/admin/address/province.table";
...
const ManageProvince = async (props: IProps) => {
    ...
    const res = await sendRequest<IBackendRes<IModelPaginate<any>>>({
        url: `${process.env.NEXT_PUBLIC_API_URL}/category/province`,
        method: "GET",
        headers: {
