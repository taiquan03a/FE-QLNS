...
const ManageEducationType = async (props: IProps) => {
    ...
    const res = await sendRequest<IBackendRes<IModelPaginate<any>>>({
        url: `${process.env.NEXT_PUBLIC_API_URL}/category/education-type`,
        method: "GET",
        headers: {
...
export default ManageEducationType;